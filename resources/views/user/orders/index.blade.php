            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr class="hover:bg-gray-50">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap">
                        @if($order->status === 'confirmed' || $order->status === 'dispatched' || $order->status === 'completed' && ($order->payment_status === 'paid' || ($order->payment->status ?? null) === 'paid'))
                    ...
                    <td lass="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $order->created_at->format('d/m/Y H:i') }}</td>

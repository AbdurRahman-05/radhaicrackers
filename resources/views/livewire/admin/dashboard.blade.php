<div>
    <div class="max-w-7xl mx-auto">
        <div class="mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between">
            ...
            <div class="mt-4 sm:mt-0 flex items-center bg-white p-3 rounded-lg shadow-sm border border-gray-100">
                <span class="mr-2 text-sm text-gray-600 font-medium">Filter by Year:</span>
                <select wire:model.live="selected_year" class="px-3 py-1.5 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm font-semibold text-gray-700 bg-white">
            ...
            <div class="bg-white rounded-lg shadow-md p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-semibold text-gray-900">{{ $stats['verified_payments'] }}</p>
                        <p class="text-sm text-gray-600">Amount: ₹{{ number_format($stats['verified_payments_amount'], 2) }}</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            ...
            <a href="{{ route('admin.stocks') }}" class="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow">
                <div class="text-4xl mb-4">📦</div>

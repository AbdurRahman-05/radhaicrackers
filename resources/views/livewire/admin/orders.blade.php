<div class="p-6 bg-white rounded-lg shadow-md">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-7 gap-4">
            ...
            <div>
                ...
                <select wire:model.live="selected_year" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                    ...
                    @php $yearsList = $available_years ?? $availableYears ?? []; @endphp
                    ...
                    <div class="border border-gray-100 rounded-xl overflow-visible">
                        ...
                        <div class="bg-gray-50 px-4 py-3 border-b border-gray-100 flex items-center justify-between">
                            ...
                            <span class="text-xs bg-gray-200 text-gray-700 px-2 py-0.5 rounded-full font-semibold">
                                {{ (is_array($currentModalItems) || $currentModalItems instanceof \Countable) ? count($currentModalItems) : 0 }} items
                            </span>
                        </div>
    ...
    <div class="fixed inset-0 bg-black bg-opacity-60 overflow-y-auto h-full w-full z-50 flex items-center justify-center p-4" id="deleteModal" wire:click.self="cancelDeleteOrder">
        <div class="relative bg-white rounded-2xl shadow-2xl border border-gray-100 max-w-md w-full p-6 text-center space-y-4">
            ...
            <h3 class="text-lg font-bold text-gray-900">Delete Order #{{ $orderIdToDelete }}?</h3>
            <p class="text-xs text-gray-600">Are you sure you want to permanently delete this order? All associated order items and logs will be removed. This action cannot be undone.</p>
            <div class="flex gap-3 pt-2">
                <button type="button" wire:click="cancelDeleteOrder" class="w-1/2 bg-gray-200 hover:bg-gray-300 text-gray-700 font-bold text-xs py-2.5 px-4 rounded-xl transition-colors">
                    Cancel
                </button>
                <button type="button" wire:click="deleteOrder" class="w-1/2 bg-red-600 hover:bg-red-700 text-white font-bold text-xs py-2.5 px-4 rounded-xl transition-colors shadow-md">
                    Delete Order
                </button>
            </div>
        </div>

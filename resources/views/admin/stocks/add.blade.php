                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        <div class="flex items-center justify-between mb-2">
                            ...
                            <a href="{{ route('admin.categories') }}" target="_blank" class="text-xs text-blue-600 hover:text-blue-800 font-medium">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="text" id="meta_title" name="meta_title" value="{{ old('meta_title') }}"
                                   class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-gray-500 focus:border-gray-500 @error('meta_title') border-red-500 @enderror"
                        ...
                        <div>
                            ...
                            <textarea id="meta_description" name="meta_description" rows="3"
                                      class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-gray-500 focus:border-gray-500 @error('meta_description') border-red-500 @enderror"
                                      placeholder="Brief summary of the product for search engine snippets">{{ old('meta_description') }}</textarea>
                        ...
                        <div>
                            ...
                            <input type="text" id="meta_keywords" name="meta_keywords" value="{{ old('meta_keywords') }}"
                                   class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-gray-500 focus:border-gray-500 @error('meta_keywords') border-red-500 @enderror"

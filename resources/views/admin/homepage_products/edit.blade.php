...
<div class="max-w-4xl mx-auto py-6 px-4 sm:px-6">
    ...
    <div class="mb-6 bg-gray-50 border border-gray-200 rounded-xl p-4 text-gray-700">
        <div class="flex items-center gap-2 mb-2">
            <span class="text-lg">🔄</span>
            <h2 class="text-sm font-bold text-gray-900">Sync from Inventory (Optional)</h2>
        </div>
        <p class="text-xs text-gray-500 mb-2">Select a product to overwrite this item's details with current inventory values:</p>
        <select id="quickStockSelect" class="w-full bg-white text-gray-900 border border-gray-300 rounded-lg p-2.5 text-xs font-medium focus:ring-2 focus:ring-amber-500">
            <option value="">-- Or choose from Inventory to overwrite fields --</option>
            ...
            <div class="flex flex-col sm:flex-row items-start sm:items-center gap-6">
                ...
                <div class="flex-1 space-y-3">
                    <div>
                        ...
                        <p class="text-[11px] text-gray-500 mt-1">Leave empty to keep the current image.</p>
                    </div>
                </div>
            </div>
        </div>

                ...
                <div class="mt-8 space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="number" id="usage_limit" name="usage_limit" value="{{ old('usage_limit', $coupon->usage_limit) }}" min="1" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 @error('usage_limit') border-red-500 @enderror" placeholder="Leave empty for unlimited">
                        ...
                        <div>
                            ...
                            <input type="number" id="user_limit" name="user_limit" value="{{ old('user_limit', $coupon->user_limit) }}" min="1" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 @error('user_limit') border-red-500 @enderror" placeholder="Leave empty for unlimited">

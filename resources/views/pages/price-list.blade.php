                                ...
                                @foreach($groupedStocks[$category->name]->sortBy('order_within_category') as $product)
                                    <tr class="border-b border-gray-100 hover:bg-gradient-to-r hover:from-gray-50 hover:to-gray-100 transition-all duration-300 group">
                                        <td class="px-6 py-6 text-center">
                                            <div class="relative">
                                                @if($product->image)
                                                    <img src="{{ $product->image_url }}" alt="{{ $product->item_name }}" class="w-48 h-48 object-cover rounded-xl border-2 border-gray-200 shadow-md group-hover:shadow-lg transition-shadow duration-300" onerror="this.onerror=null; this.src='/images/firework-default.png'">
                                                @else
                    ...
                    <div class="bg-white rounded-2xl shadow-lg p-4 border border-gray-100 hover:shadow-xl transition-shadow duration-300">
                        <div class="flex flex-col sm:flex-row sm:items-start gap-4">
                            ...
                            <div class="relative w-full sm:w-40 flex-shrink-0">
                                @if($product->image)
                                    <img loading="lazy" src="{{ $product->image_url }}" alt="{{ $product->item_name }}" class="w-full h-auto sm:h-40 object-cover rounded-xl border-2 border-gray-200 shadow-md" onerror="this.onerror=null; this.src='/images/firework-default.png'">
                                @else

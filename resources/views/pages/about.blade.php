...
<div class="bg-white py-8">
    <div class="max-w-5xl mx-auto px-4">
        ...
        <!-- Page Title -->
        <h1 class="text-3xl md:text-4xl font-bold text-gray-900 mb-6 text-center">About Us</h1>
<!-- Hero Section -->
        <div class="mb-8">
            <h2 class="text-2xl md:text-3xl font-semibold text-gray-800 mb-2">Spreading Joy, One Spark at a Time</h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <div class="bg-purple-900 text-white rounded-lg p-6 text-center font-semibold">200+ varieties of crackers for all ages and events</div>

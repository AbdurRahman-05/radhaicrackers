    ...
    <div class="mb-8">
        <div class="flex items-center justify-center">
            <div class="flex items-center">
                ...
                <div class="ml-2 text-sm font-medium text-blue-600">Cart Review</div>
            </div>
            ...
            <div class="flex items-center">
                ...
                <div class="ml-2 text-sm font-medium text-gray-500">Customer Details</div>
            </div>
            <div class="flex-auto border-t-2 border-gray-300 mx-4"></div>
            <div class="flex items-center">
                <div class="bg-gray-300 text-gray-600 rounded-full h-8 w-8 flex items-center justify-center text-sm font-bold">3</div>
                <div class="ml-2 text-sm font-medium text-gray-500">Payment & Confirm</div>
            </div>
        </div>
    </div>
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="bg-white rounded-lg shadow-md p-6">
                ...
                <div class="flex space-x-2 mb-4">
                    <input type="text" id="coupon-code" class="flex-1 border border-gray-300 rounded-lg px-4 py-2 focus:ring-2 focus:ring-purple-500 focus:border-transparent" placeholder="Enter coupon code">
                    <button type="button" id="apply-coupon" class="bg-purple-600 hover:bg-purple-700 text-white px-6 py-2 rounded-lg font-medium transition duration-200">
                        Apply
                    </button>
                </div>
...
class SmartCheckout {
    constructor() {
        ...
        // Clear any previously stored coupon data on page load

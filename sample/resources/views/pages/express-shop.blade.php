        ...
        @else
            ...
            <div class="mt-8 border-t border-gray-200 pt-6 ">
                <div class="flex justify-between items-center">
                    ...
                    id= "estimate-pdf-btn"
                    class=" w-full text-white  px-4 py-2 rounded-lg hover:bg-orange-600 transition-colors bg-[#B67121] disabled:bg-gray-400 disabled:cursor-not-allowed "  
                    
                    disabled
                    >Estimate</button>
                    <button
                    id="checkout-btn"
                    onclick="proceedToCheckout()" class="  text-white px-4 py-2 rounded-lg hover:bg-gray-600 transition-colors font-semibold bg-[#1E093B]  disabled:bg-gray-400 disabled:cursor-not-allowed"
                    disabled
                    >
                     Checkout
                    </button>
...
function updateCheckoutButton() {
       ...
       document.getElementById('checkout-btn').disabled = selectedProducts.length === 0;
       document.getElementById('estimate-pdf-btn').disabled = selectedProducts.length === 0;
   }
...
function generateEstimate() {
    ...
    // Optionally, collect customer info here if needed
    const customer = {
        name: '', // fill from form if available
        mobile: '',
        email: '',
        city: '',
        state: '',
    ...
    fetch("{{ route('express-shop.estimate-pdf') }}", {
        method: "POST",
        headers: {

...
<div class="header-box">
    <div class="header-row">
        ...
        <div style="flex:1;">
            ...
            <div class="company-title">Rathe Crackers    </div>
    ...
    <div class="contact-row">
        <div class="contact-item"><span class="contact-icon"><strong>Phone:</strong></span>+91 8807060809, 9751048974</div>
        <div class="contact-item"><span class="contact-icon"><strong>Email:</strong></span> radhecrackers@gmail.com</div>
        <div class="contact-item"><span class="contact-icon"><strong>Website:</strong></span> www.radhecrackers.com</div>
    </div>
</div>
<div class="wrapper">
    <!-- Left Column: Info -->

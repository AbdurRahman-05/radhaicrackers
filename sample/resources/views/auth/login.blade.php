...
<div class="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full space-y-8">
        ...
        <div class="text-center mt-6">
            <p class="text-sm text-gray-500">Enter your <span class="font-semibold text-gray-900">Name</span> and <span class="font-semibold text-gray-600">Phone Number</span> to get an OTP via SMS.<br>Use the OTP to log in securely.</p>
        </div>
    </div>
</div>
@endsection 
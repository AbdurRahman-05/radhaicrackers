...
class AdminController extends Controller
{
    ...
    public function dashboard()
    {
        $stats = [
            ...
            'today_payments' => Payment::whereDate('verified_at', today())->count(),
            'recent_activity' => OrderLog::with('order')->latest()->take(5)->get(),
        ];
    ...
    private function exportStocksCSV($stocks)
    {
        ...
        $callback = function() use ($stocks) {
            ...
            // CSV Headers
            fputcsv($file, ['Stock ID', 'Name', 'Description', 'Quantity', 'Price', 'Total Value', 'Status', 'Created Date']);

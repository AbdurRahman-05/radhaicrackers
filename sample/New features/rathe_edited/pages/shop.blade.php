...
<!-- Cart Summary -->
<div class="fixed bottom-4 right-4 bg-white rounded-lg shadow-lg p-4 border" id="cart-summary" style="display: none;">
...
function proceedToCheckout() {
    ...
    window.location.href = `{{ route('order.form') }}?items=${items}`;
}

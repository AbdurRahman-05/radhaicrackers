    ...
    <div class="overflow-x-auto">
        <table class="min-w-full bg-white border border-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <div class="flex space-x-2">
                            <form action="{{ route('admin.stocks.toggle-show-on-shop', $stock->id) }}" method="POST" class="inline">
                                ...
                                <button type="submit" 
                                        ...
                                        @endif">
                                    {{ $stock->show_on_shop ? 'Hide on Stock' : 'Show on Stock' }}
                                </button>
                            </form>
                            <a href="{{ route('admin.stocks.edit', $stock->id) }}" class="text-blue-600 hover:text-blue-900">Edit</a>
                            <form action="{{ route('admin.stocks.destroy', $stock->id) }}" method="POST" class="inline" 
                ...
                @empty
                <tr>
                    <td colspan="8" class="px-6 py-4 text-center text-gray-500">No stocks found</td>
                </tr>
                @endforelse
            </tbody>
        </table>
